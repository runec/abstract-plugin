    ...
    <form method="post" enctype="multipart/form-data" id="wpabs_review_form">
        <div class="inner-sidebar">
            <div class="misc-pub-section">
                ...
                <input type="button" onclick="wpabstracts_validateReview();" class="button button-primary button-large" value="<?php _e('Update Review', 'wpabstracts'); ?>" />
            </div>
            ...
            <div class="postbox">
                ...
                <div class="inside">
                    <input type='radio' name='abs_relevance' value='Excellent' <?php checked($review['relevance'], __('Excellent', 'wpabstracts')); ?> /> <?php _e('Excellent', 'wpabstracts'); ?><br>
                    <input type='radio' name='abs_relevance'  value='Good' <?php checked($review['relevance'], "Good"); ?> /> <?php _e('Good', 'wpabstracts'); ?><br>
                    <input type='radio' name='abs_relevance' value='Average' <?php checked($review['relevance'], "Average"); ?> /> <?php _e('Average', 'wpabstracts'); ?><br>
                    <input type='radio' name='abs_relevance' value='Poor' <?php checked($review['relevance'], "Poor" ); ?> /> <?php _e('Poor', 'wpabstracts'); ?><br>
                </div>
            </div>
            <div class="postbox">
                <h3><?php _e('Quality', 'wpabstracts'); ?></h3>
                <div class="inside">
                    <td><input type='radio' name='abs_quality' value='Excellent' <?php checked($review['quality'], "Excellent"); ?> /> <?php _e('Excellent', 'wpabstracts'); ?><br>
                    <input type='radio' name='abs_quality' value='Good' <?php checked($review['quality'], "Good"); ?> /> <?php _e('Good', 'wpabstracts'); ?><br>
                    <input type='radio' name='abs_quality' value='Average' <?php checked($review['quality'],"Average"); ?> /> <?php _e('Average', 'wpabstracts'); ?><br>
                    <input type='radio' name='abs_quality' value='Poor'
                    <?php checked($review['quality'], "Poor"); ?> /> <?php _e('Poor', 'wpabstracts'); ?><br>
                </div>
            </div>
            <div class="postbox">
                <h3><?php _e('Suggest Status', 'wpabstracts'); ?></h3>
                <div class="inside">
                    <input type='radio' name='abs_status' value='Pending' <?php checked($review['status'] , "Pending")  ?> /> <?php _e('Pending', 'wpabstracts');?><br>
                    <input type='radio' name='abs_status' value='Approved' <?php checked($review['status'], "Approved"); ?> /> <?php _e('Approved', 'wpabstracts');?><br>
                    <input type='radio' name='abs_status' value='Rejected' <?php checked($review['status'], "Rejected"); ?> /> <?php _e('Rejected', 'wpabstracts');?><br>
                </div>
            </div>
            <div class="clear"></div>
            <?php
