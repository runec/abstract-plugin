    ...
    <form method="post" enctype="multipart/form-data" id="abs_form">
        <div class="inner-sidebar">
            <div class="misc-pub-section">
                <input type="button" onclick="appendImageToForm();wpabstracts_validateAbstract();" class="button button-primary button-large" value="<?php _e('Update Abstract', 'wpabstracts');?>" />
            </div>
            ...
            */
            ...
            <?php } */?>
            <?php
            $profile_image = get_site_url().'/wp-content/plugins/wpabstracts_pro/profile-images/'.$abstract[0]->profile_image;
             ?>
            <div class="postbox">
              <h3><?php _e('Photo', 'wpabstracts'); ?></h3>
                <div id='abstract-photo-preview'><img src="<?php echo $profile_image ?>"></div>
