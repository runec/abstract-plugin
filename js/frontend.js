...
function sortAbstractsAlphabetically() {
  jQuery('#abstract-session-list').removeClass('active');
  ...
  jQuery("#abstract-frontend-listing").empty().append(divList);
}
...
function setSession(session) {
  jQuery('#abstract-session-list').addClass('active');
  console.log('#'+session);
  jQuery('#'+session).click();
}
