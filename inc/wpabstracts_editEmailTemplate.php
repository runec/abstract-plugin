        ...
        <div class="inner-sidebar">
            <div class="postbox">
                ...
                <div class="inside">
                    ...
                    <h4>- <?php _e('User data', 'wpabstracts');?></h4>
                    <p><?php _e("User name",'wpabstracts'); ?>: {USER_NAME}</p>
                    <p><?php _e("User company",'wpabstracts'); ?>: {USER_COMPANY}</p>
                    <p><?php _e("User email",'wpabstracts'); ?>: {USER_EMAIL}</p>
                    <p><?php _e("User phone",'wpabstracts'); ?>: {USER_PHONE}</p>
                    <h4>- <?php _e('Abstract data (only for single abstract)', 'wpabstracts');?></h4>
